<template>
    <div class="pagination">
        <button class="pageBtn" :disabled="currentGroup === 1" @click="goToFirstGroup">
        ...
        <button class="pageBtn" :disabled="endPage >= totalPages" @click="nextGroup">
            <i class="fas fa-angle-right"></i>
        </button>

        <button class="pageBtn" :disabled="endPage >= totalPages" @click="goToLastGroup">
