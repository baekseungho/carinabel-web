      ...
      <div class="signupFormContainer">
        ...
        <form @submit.prevent="handleSubmit">
          <div v-if="step === 1">
            ...
            <button type="button" class="signupButton" @click="nextStep">
              다음으로
            </button>
          </div>
            ...
            <div class="inputGroup">
              ...
              <div class="address-wrapper">
                <input
                  ...
                  class="readonly-address"
                />
                <button type="button" class="search-btn" @click="copyAddress">
                  주소 복사
                </button>
              </div>
            </div>
...
const handleSubmit = () => {
  ...
  const address =
    `${zoneCode.value} ${baseAddress.value} ${detailAddress.value}`.trim();
