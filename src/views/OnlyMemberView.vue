<template>
    <div class="product-container">
        <h1 class="product-title">에센셜 오일</h1>
        <div class="product-grid">
            <Card v-for="product in products" :key="product.id" class="product-card" @click="goToDetail(product._id)">
                <CardImage :src="product.imagePath || '/img/default_product.png'" :alt="product.koreanName" />
                <CardContent>
